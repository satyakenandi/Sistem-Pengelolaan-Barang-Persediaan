...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | Sistem Pengelolaan Barang Persediaan</title>
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="?module=home" class="logo">SPBP Ditjen PSDKP</a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2018 - Ditjen PSDKP Kementerian Kelautan dan Perikanan</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
