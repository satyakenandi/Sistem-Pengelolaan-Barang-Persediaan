...
if (isset($_GET['tgl_awal'])) {
    ...
    // $query = mysqli_query($mysqli, "SELECT a.id_barang_masuk,a.id_barang,a.id_nota,a.jumlah_masuk,a.harga_barang,b.id_barang,b.nama_barang,b.id_satuan,c.id_satuan,c.nama_satuan,d.id_nota,d.tanggal_nota
    //                                 FROM is_barang_masuk ON as a INNER JOIN is_barang ON as b INNER JOIN is_satuan ON as c INNER JOIN is_nota ON as d
    //                                 ON a.id_barang=b.id_barang AND b.id_satuan=c.id_satuan AND d.id_nota
    //                                 WHERE d.tanggal_nota BETWEEN '$tgl_awal' AND '$tgl_akhir'
    ...
    // die(print_r(mysqli_fetch_assoc($query)));
}
?>
...
<?php
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            $exp           = explode('-',$tanggal);
            $tanggal_nota = tgl_eng_to_ind($exp[2]."-".$exp[1]."-".$exp[0]);

            // menampilkan isi tabel dari database ke tabel di aplikasi
            echo "  <tr>
                        <td width='40' height='13' align='center' valign='middle'>$no</td>
                        <td width='120' height='13' align='center' valign='middle'>$data[id_nota]</td>
                        <td width='120' height='13' align='center' valign='middle'>$tanggal_nota</td>
