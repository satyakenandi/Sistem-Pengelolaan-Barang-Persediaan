...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
   ...
   <!--  <div class="text-center">
    <b>KEMENTERIAN KELAUTAN DAN PERIKANAN</b><br>
    <b>DIREKTORAT JENDERAL PENGAWASAN</b><br>
    <b>SUMBER DAYA KELAUTAN DAN PERIKANAN</b><br>
    <b>Jalan Medan Merdeka Timur No.16 Gedung Mina Bahari IV Lantai 11 Jakarta 10110 </b><br>
    <b>Kotak Pos 4130 JKP 10041 Telepon : (021) 3514728 (Hunting) Faksimile : (021) 3515484</b><br>
    <b>Website : www.djpsdkp.kkp.go.id E-mail : ditjenpsdkp@kkp.go.id</b>
    </div> -->
        <div id="title">
            LAPORAN STOK BARANG  
        </div>
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td width='170' height='13' align='center' valign='middle'>$data[id_barang]</td>
                        <td style='padding-left:5px;' width='170' height='13' valign='middle'>$data[nama_barang]</td>
                        <td style='padding-left:5px;' width='150' height='13' valign='middle'>$data[nama_jenis]</td>
                        <td style='padding-right:10px;' width='40' height='13' align='right' valign='middle'>$data[stok]</td>
        ...
        ?>  
            ...
            <div id="footer-tanggal">
                Jakarta Pusat, <?php echo tgl_eng_to_ind("$hari_ini"); ?>
            </div>
...
<?php
$filename="Stok_Barang.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
