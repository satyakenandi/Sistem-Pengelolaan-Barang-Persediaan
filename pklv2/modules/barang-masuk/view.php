...
<section class="content">
  ...
  <script type="text/javascript">
    function getmodaldata(value){
      ...
      $.ajax ({
      method:'GET',
      url:'http://localhost/pklv2/modules/barang-masuk/modal.php',
      dataType:'JSON',
      data:{id_nota:value},
      success:function(data){
        ...
        var isi_element='<tr><td>'+value.id_nota+'</td><td>'+value.id_barang+'</td><td>'+value.nama_barang+'</td><td>'+value.harga_barang+'</td><td>'+value.jumlah_masuk+'</td></tr>'
