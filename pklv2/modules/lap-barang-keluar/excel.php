...
<!-- Buat Table saat di Export Ke Excel -->
	<center>
		<h3>DATA BARANG KELUAR Ditjen PSDKP <br>
	    <?php  
		...
		<h3>
			<thead>
				<tr>
					...
					<td align="center" valign="top" width="100">JUMLAH KELUAR</td>
				</tr>
			</thead>
		</h3>
        ...
        if ($count > 0) {
            ...
            ?>
				<tr>
				    ...
				    <td valign="top"><?php echo $data['id_barang_keluar']; ?></td>
				    <td align="center" valign="top"><?php echo $data['tanggal_keluar']; ?></td>
				    <td align="center" valign="top"><?php echo $data['id_barang']; ?></td>
				    <td align="center" valign="top"><?php echo $data['nama_barang']; ?></td>
				    <td align="center" valign="top"><?php echo $data['jumlah_keluar'], $data['nama_satuan']; ?></td>
				</tr>
			<?php
				$no++;
			}
