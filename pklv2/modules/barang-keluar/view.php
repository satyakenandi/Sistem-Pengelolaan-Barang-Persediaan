      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.id_barang_keluar,a.tanggal_keluar,a.id_barang,a.jumlah_keluar,b.id_barang,b.nama_barang,b.id_satuan,c.id_satuan,c.nama_satuan,d.id_user,d.nama_user
            ...
            while ($data = mysqli_fetch_assoc($query)) {
              ...
              echo "<tr>
                      ...
                      <div>
                        ";
                        // <a data-toggle='tooltip' data-placement='top' title='Ubah' style='margin-right:5px' class='btn btn-primary btn-sm' href='?module=form_barang_keluar&form=edit&id=$data[id_barang_keluar]'>
                        //       <i style='color:#fff' class='glyphicon glyphicon-edit'></i>
                        //   </a>
          ?>
                       <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="modules/barang-keluar/proses.php?act=delete&id=<?php echo $data['id_barang_keluar'];?>" onclick="return confirm('Anda yakin ingin menghapus barang keluar <?php echo $data['nama_barang']; ?> ?');">
