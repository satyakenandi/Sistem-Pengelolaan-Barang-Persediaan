...
// jika user sudah login, maka jalankan perintah untuk pemanggilan file halaman konten
	...
	// jika halaman konten yang dipilih kode barang, panggil file view kode barang
	elseif ($_GET['module'] == 'kode_barang') {
		include "modules/kode-barang/view.php";
	}

	// jika halaman konten yang dipilih form kode barang, panggil file form kode barang
	elseif ($_GET['module'] == 'form_kode_barang') {
		include "modules/kode-barang/form.php";
	}
	// -----------------------------------------------------------------------------
	...
	// jika halaman barang masuk kasubbag yang dipilih, panggil file barang masuk kasubbag
	elseif ($_GET['module'] == 'masuk_kasubbag') {
		include "modules/masuk-kasubbag/view.php";
	}
	// -----------------------------------------------------------------------------

	// jika halaman barang keluar kasubbag yang dipilih, panggil file barang keluar kasubbag
	elseif ($_GET['module'] == 'keluar_kasubbag') {
		include "modules/keluar-kasubbag/view.php";
	}
